	...
	<!-- BEGIN: FILES_ROW -->
		...
		<li class="uk-width-1-1 uk-width-3-4@m">
			...
			<canvas width="640" height="420"></canvas>
				<a href="{FILES_ROW_URL}" data-caption="{FILES_ROW_TITLE_OR_NAME}" alt="{FILES_ROW_TITLE_OR_NAME}">
				<img uk-cover src="{FILES_ROW|cot_filesThumbnailUrl($this,1153,523,'outbound')}" alt="{FILES_ROW_TITLE_OR_NAME}" title="{FILES_ROW_TITLE_OR_NAME}" />  
				</a>
